...
function Home() {
  ...
  const REDIRECT_URI = "https://homework-gigi-spotifyyyy-26jto47wu-muhamadagmaldo.vercel.app/";
  ...
  return (
    <div className="Home">
      ...
      <div className="content">
        <p className="title">
        <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="#11e449" class="bi bi-spotify" viewBox="0 0 16 16">
